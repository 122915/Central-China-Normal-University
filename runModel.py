...
if __name__ == "__main__":
    # student_data = input("Enter the student data file in csv format: ")
    student_data = "00_Data_student data file.csv"

    # skill_map = input("Enter the activity-skill map file in csv format: ")
    skill_map = "01_Data_activity-skill map file.csv"

    # m = input("Enter the model to use: {bkt, bkt-cont}: ")
    m = "bkt"

    # n_folds = input("Enter the number of cross validation folds: ")
    n_folds = 5
